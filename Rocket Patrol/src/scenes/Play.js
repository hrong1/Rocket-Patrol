class Play extends Phaser.Scene {
    ...
    create() {
        // place tile sprite
        this.add.starfield = this.add.tileSprite(0, 0, 640, 480, 'starfield').setOrigin(0, 0)
    ...
    update() {
        ...
        if(this.checkCollision(this.p1Rocket, this.ship03)) {
            this.p1Rocket.reset()
            this.shipExploade.reset(this.ship03)
        }
        if (this.checkCollision(this.p1Rocket, this.ship02)) {
            this.p1Rocket.reset()
            this.shipExploade.reset(this.ship02)
        }
        if (this.checkCollision(this.p1Rocket, this.ship01)) {
            this.p1Rocket.reset()
            this.shipExploade.reset(this.ship01)
        }
    }
